...
class ViewController: UIViewController {
    ...
    private lazy var conteinerView: UIImageView = {
    ...
    private lazy var conteinerView1: UIImageView = {
    ...
    private func updateConstraints2() {
    ...
    private func updateConstraints3() {
    ...
    private func updateConstraints4() {
    ...
    private func updateConstraints5() {
    ...
    private func updateConstraints6() {
        addButton.leftAnchor.constraint(equalTo: textField.leftAnchor, constant: 330).isActive = true
        addButton.rightAnchor.constraint(equalTo: view1.rightAnchor, constant: -20).isActive = true
        addButton.topAnchor.constraint(equalTo: view1.topAnchor, constant: 17).isActive = true
    }
